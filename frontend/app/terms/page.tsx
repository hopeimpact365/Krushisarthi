    ...
    <div className="max-w-4xl mx-auto px-4 py-12 md:py-20">
      ...
      <div className="prose prose-stone dark:prose-invert max-w-none space-y-6 text-muted-foreground">
        <section>
          ...
          <p>
            By accessing or using our website <Link href="/" className="text-primary hover:underline">{siteConfig.url}</Link>, purchasing products, 
            or booking farm plots on {siteConfig.name}, you agree to be bound by these Terms and Conditions. If you do not agree with any part of these terms, 
        ...
        <section>
          ...
          <p>
            ...
            While we strive to deliver the highest quality organic jaggery and manage farm plots with best agricultural practices, 
